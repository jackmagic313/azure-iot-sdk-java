...
public class QueryCollection
{
     ...
     * @throws IllegalArgumentException if page size is 0 or negative, or if the query type is null or unknown, or if the provided
    ...
    {
        validateQueryRequestArguments(iotHubConnectionString, url, httpMethod);
     ...
     *
     * @param options the options for the query. If a continuation token is set in these options, it will override any
     *                previously saved tokens. The page size of these options will override any previously saved page size
    ...
    /**
     * Returns if this query collection has a next collection to return. The query shall continue with the
     * current page size.
     *
    ...
    /**
     * Returns the next QueryCollectionResponse object. The query shall continue with the same page size and use the next continuation token.
     * @return The next QueryCollectionResponse object or null if there is not next QueryCollectionResponse object
     * @throws IOException If an IOException occurs when calling the Service API, or if the results of that call are unexpected
     * @throws IotHubException If an IotHubException occurs when calling the Service API
     */
    ...
    private void validateQueryRequestArguments(IotHubConnectionString iotHubConnectionString, URL url, HttpMethod method)
    {
